...
Hauptprädikat. ASCII-File lesen, mit Grammatik Symbole erzeugen,
Symbole zurückgeben
...
Dieses Prädikat wird für die Dateiarbeit eingesetzt.
Eine ASCII-Datei wird geöffnet, die Funktion \verb|scanner_read_char/3|
...
Aus dem Stream \verb|S| wird die ASCII-Datei Zeichen für Zeichen eingelesen.
...
wird um 1 länger. Bei jedem Aufruf von \verb|dl_push_back| wird zur
Differenzliste das gerade gelesene Zeichen hinzugefügt.
...
Dieses Prädikat gibt die Liste der erzeugten Symbole in
...
Prädikat zum Bearbeiten des Dokumentes.
...
Reihenfolge mehr lesbar, so wird \verb|scanner_doc_child| beim nächsten
...
Dieses Prädikat versucht, Whitespaces am Anfang einer Zeile zu lesen,
...
Dieses Prädikat liest vorformatierten Text.

Aus \verb|"""T"""| werden die Symbole \verb|sym_pre|, \verb|sym_text(T)|,
\verb|sym_pre| erzeugt. Alle gefundenen Zeichen werden als Text 1:1 übernommen.
Dazu wird das Prädikat \verb|scanner_pretext| aufgerufen.
...
Dieses Prädikat liest alle Zeichen bis zum auftreten von \verb|"""|.
...
Dieses Prädikat liest Text, und erzeugt das Symbol \verb|sym_text(T)|.
...
Dieses Prädikat findet eine Leerzeile, und erzeugt dann das Symbol
\verb|sym_break|.
...
Dieses Prädikat findet Spaltentrenner, und erzeugt dann das Symbol
\verb|sym_col_seperator|. Whitespaces zwischen dem Spaltentrenner und dem
nachfolgenden Text werden überlesen.
...
Dieses Prädikat liest Zeichen fuer \verb|sym_text|. Das Einlesen wird beim
...
Dieses Prädikat liest Zeichen, solange diese Whitespaces sind.
...
Dieses Prädikat sucht Unterstreichungen mit \verb|*****|. Wird diese Art der
...
Dieses Prädikat sucht einzubettende Objekte, zum Beipiel Bilder. Werden die
Zeichen \verb|<<| und \verb|>>| gefunden, so werden die Zeichen dazwischen
als Text übergeben.

Von diesem Prädikat werden folgende Symbole erzeugt: \verb|sym_begin_include|,
...
Dieses Prädikat wird von \verb|scanner_include| aufgerufen.
...
Dieses Prädikat findet Listenanstriche, und erzeugt dann das Symbol
...
Dieses Prädikat findet Aufzaehlungsanstriche, und erzeugt dann das Symbol
...
Dieses Prädikat überliest 0..n Whitespaces. Es wird aufgerufen von
